...
class WikiEmbeddingTrainer:
    def __init__(self, base_dir: str = 'data/wiki_gen'):
    ...
    def preprocess_articles(self, articles: List[Dict]) -> List[List[str]]:
        """Preprocess articles into tokenized sentences."""
        processed_articles = []
        language = articles[0]['language']  # Assume all articles in list are same language
