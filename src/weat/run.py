...
if __name__ == '__main__':
    ...
    parser.add_argument('--word_embedding_type', type=str, required=False, default='word2vec',
                        help='only word2vec')
    parser.add_argument('--lang', type=str, required=True, 
                        help='Language of word embedding.')
    parser.add_argument('--word_embedding_path', type=str, required=False, default=None,
    ...
    args.word_embedding_path = utils.model_paths[args.lang]
    args.weat_path = f'data/weat/{args.lang}.json'
    args.output = f'output/output_{args.lang}.csv'
    print('Arguments:')
